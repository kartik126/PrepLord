          ...
          <div className="flex space-x-20">
            <div className="text-white">
              {exams.map((exam, index) => (
                <p
                  className="cursor-pointer hover:underline pb-1 text-sm font-regular"
                  key={index}
                >
                  {exam}
                </p>
            ...
            <div className="text-white">
              {exams.map((exam, index) => (
                <p
                  className="cursor-pointer hover:underline pb-1 text-sm font-regular pl-10"
                  key={index}
                >
                  {exam}
                </p>
          ...
          <div className="flex space-x-10">
            <div className="text-white">
              {previousYearPapers.map((exam, index) => (
                <p
                  className="cursor-pointer hover:underline pb-2 text-sm font-regular"
                  key={index}
                >
                  {exam}
                </p>
            ...
            <div className="text-white">
              {previousYearPapers.map((exam, index) => (
                <p
                  className="cursor-pointer hover:underline pb-2 text-sm font-regular pl-10"
                  key={index}
                >
                  {exam}
                </p>
