                        ...
                        <input
                          ...
                          className={`mr-2 ${
                            isOptionSelectedAndWrong(option.text)
                              ? "text-red-500 " // Green background for selected and wrong option
                              : selectedOptions[currentQuestion] != null &&
                                option.isCorrect
                              ? "text-green-600 " // Green background for correct option
                              : isOptionSelectedAndWrong(option.text)
                              ? "text-red-500" // Red background for selected and wrong option
                              : ""
                          }`}
                          disabled={
                            selectedOptions[currentQuestion] === option.text
